...
export default function () {
	return (
		<div className='max-w-[1200px] m-auto'>
			...
			<div
				className='w-full bg-[url("https://github.com/tomkin-heart/My-React-Experimets/blob/main/public/flexbox_business/bg.jpg")] bg-cover bg-center rounded flex justify-center items-center'
				id='home'
			>
